	...
	<div class="container custom-container">
		...
		<div class="search hidden-xs">
			...
			<div class="search-cat">
				...
				<ul>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/energy%20%26%20utilities/">Energy & utilities</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/consumer%20services/">Consumer services</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/information%20%26%20media/">Information & media</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/healthcare/">Healthcare</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/technology/">Technology</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/transportation/">Transportation</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/telecommunications/">Telecommunications</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/financials/">Financials</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/consumer%20goods/">Consumer goods</a></li>
					<li><a href="<?php echo home_url() ?>/business-strategy/sector/industrials/">Industrials</a></li>
				</ul>
			</div>
		</div>
