...
define('PWT_PLUGIN', 'pay-with-a-tweet');
...
define('PWT_PLUGIN_UPLOAD_DIR', WP_CONTENT_DIR . '/uploads/pay-with-a-tweet');
define('PWT_PLUGIN_UPLOAD_URL', WP_CONTENT_URL . '/uploads/pay-with-a-tweet');
